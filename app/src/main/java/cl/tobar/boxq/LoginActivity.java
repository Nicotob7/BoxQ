...
public class LoginActivity extends AppCompatActivity {
    ...
    Button btn_login, btn_register, btn_login_anonymus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login_anonymus = findViewById(R.id.btn_anonymus);
        ...
        btn_login_anonymus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loginAnonymus();
            }
